...
class FunctionsController extends Controller
{
    ...
    public function actionIndex() {
        ...
        echo '<p>Реализована сортировка методом orderBy. Может передаваться несколько полей для сортировки, а также использоваться DESC</p>';    
        echo '<p>Реализована фильтрация методами where и orWhere. Методы могут принимать 2 или 3 параметра. Если параметра 2, то подразумевается, что используется знак "="</p>';    
        ...
        <li>Products::where('price','<','50000')->orderBy('name DESC')->get();</li>
        </ul>";      
        echo '<hr><br>';
